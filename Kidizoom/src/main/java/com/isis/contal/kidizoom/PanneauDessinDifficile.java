...
public class PanneauDessinDifficile extends JPanel {

    private DessinNiveauDifficile parent;
    private Image image;
    private Graphics2D g2;
    private int startX, startY, endX, endY;

    public PanneauDessinDifficile(DessinNiveauDifficile parent) {
        this.parent = parent;
        ...
        addMouseListener(new MouseAdapter() {
            ...
            public void mouseReleased(MouseEvent e) {
                ...
                g2.setColor(parent.getCurrentColor());
                g2.setStroke(new BasicStroke(parent.getBrushSize()));

                switch (parent.getSelectedShape()) {
                    case "Cercle":
        ...
        addMouseMotionListener(new MouseAdapter() {
            public void mouseDragged(MouseEvent e) {
                if (parent.getSelectedShape().equals("Libre")) {
                    if (g2 == null) {
                        image = createImage(getWidth(), getHeight());
                        g2 = (Graphics2D) image.getGraphics();
                        g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
                    ...
                    if (parent.isErasing()) {
                        ...
                        g2.setStroke(new BasicStroke(parent.getEraserSize()));
                    } else {
                        g2.setColor(parent.getCurrentColor());
                        g2.setStroke(new BasicStroke(parent.getBrushSize()));
                    }
